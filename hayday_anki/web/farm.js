...
const BUILDING_SVGS = {
  bakery: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80'%3E%3Cellipse cx='40' cy='76' rx='32' ry='4' fill='%23000' opacity='.12'/%3E%3Crect x='12' y='44' width='56' height='30' rx='2' fill='%23e8c87a'/%3E%3Crect x='12' y='44' width='56' height='30' rx='2' stroke='%23c9a050' stroke-width='.6' fill='none'/%3E%3Crect x='13' y='45' width='26' height='28' fill='%23f0d898' opacity='.25'/%3E%3Cpath d='M8 44L40 20l32 24z' fill='%23d4534a'/%3E%3Cpath d='M12 44L40 24l28 20z' fill='%23e8665e'/%3E%3Cpath d='M16 44L40 27l24 17z' fill='%23ef9a9a' opacity='.25'/%3E%3Crect x='30' y='54' width='20' height='20' rx='3' fill='%236d4c41'/%3E%3Crect x='31' y='55' width='18' height='14' rx='2' fill='%23ffd54f' opacity='.4'/%3E%3Cpath d='M31 62h18' stroke='%236d4c41' stroke-width='.5'/%3E%3Crect x='16' y='50' width='10' height='8' rx='1.5' fill='%236d4c41'/%3E%3Crect x='17' y='51' width='8' height='6' rx='1' fill='%23ffd54f' opacity='.35'/%3E%3Crect x='54' y='50' width='10' height='8' rx='1.5' fill='%236d4c41'/%3E%3Crect x='55' y='51' width='8' height='6' rx='1' fill='%23ffd54f' opacity='.35'/%3E%3Crect x='60' y='18' width='6' height='26' rx='1.5' fill='%23999'/%3E%3Cellipse cx='63' cy='15' rx='4' ry='5' fill='%23ccc' opacity='.45'/%3E%3Cellipse cx='63' cy='12' rx='3' ry='4' fill='%23ddd' opacity='.3'/%3E%3Cellipse cx='63' cy='10' rx='2' ry='3' fill='%23eee' opacity='.2'/%3E%3Ccircle cx='37' cy='63' r='4' fill='%23e8b87a' stroke='%23c9884a' stroke-width='.5'/%3E%3Ccircle cx='37' cy='62' r='2.8' fill='%23daa06d'/%3E%3Ccircle cx='45' cy='65' r='3' fill='%23c9884a'/%3E%3Ccircle cx='45' cy='64.5' r='2' fill='%23daa06d'/%3E%3Crect x='18' y='36' width='14' height='6' rx='2' fill='%23e8b060' stroke='%23c99040' stroke-width='.4'/%3E%3Ctext x='25' y='41' text-anchor='middle' font-size='4.5' font-weight='bold' fill='%23fff' opacity='.7'%3EPAIN%3C/text%3E%3C/svg%3E",
  sugar_mill: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80'%3E%3Cellipse cx='40' cy='76' rx='32' ry='4' fill='%23000' opacity='.1'/%3E%3Crect x='15' y='35' width='50' height='40' rx='3' fill='%23e8e0d0'/%3E%3Crect x='15' y='35' width='50' height='40' rx='3' stroke='%23c8bfa8' stroke-width='.5' fill='none'/%3E%3Crect x='16' y='36' width='24' height='38' fill='%23f0e8d8' opacity='.25'/%3E%3Cpath d='M10 35L40 15l30 20z' fill='%23c9884a'/%3E%3Cpath d='M15 35L40 19l25 16z' fill='%23daa06d'/%3E%3Cpath d='M19 35L40 22l21 13z' fill='%23e8c87a' opacity='.25'/%3E%3Crect x='30' y='55' width='20' height='20' rx='2' fill='%238b5e3c'/%3E%3Crect x='32' y='57' width='16' height='14' rx='1' fill='%23ffd54f' opacity='.3'/%3E%3Ccircle cx='57' cy='28' r='12' fill='%23c9884a' stroke='%23a06a30' stroke-width='1'/%3E%3Cpath d='M57 16v24M45 28h24' stroke='%23a06a30' stroke-width='2.5'/%3E%3Cpath d='M49 20l16 16M49 36l16-16' stroke='%23a06a30' stroke-width='1.5'/%3E%3Ccircle cx='57' cy='28' r='4' fill='%23daa06d'/%3E%3Ccircle cx='57' cy='28' r='2' fill='%23e8c87a'/%3E%3Crect x='20' y='60' width='6' height='10' rx='1' fill='%23f5f0e0' stroke='%23c8bfa8' stroke-width='.4'/%3E%3Ctext x='23' y='67' text-anchor='middle' font-size='3.5' fill='%23a08860'%3ES%3C/text%3E%3Crect x='17' y='62' width='5' height='8' rx='1' fill='%23f5f0e0' stroke='%23c8bfa8' stroke-width='.3'/%3E%3C/svg%3E",
  dairy: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80'%3E%3Cellipse cx='40' cy='76' rx='32' ry='4' fill='%23000' opacity='.08'/%3E%3Crect x='12' y='38' width='56' height='36' rx='3' fill='%23f5f5f5'/%3E%3Crect x='12' y='38' width='56' height='36' rx='3' stroke='%23ddd' stroke-width='.5' fill='none'/%3E%3Crect x='13' y='39' width='26' height='34' fill='%23fafafa' opacity='.3'/%3E%3Cpath d='M8 38L40 16l32 22z' fill='%234fc3f7'/%3E%3Cpath d='M14 38L40 20l26 18z' fill='%2381d4fa'/%3E%3Cpath d='M18 38L40 24l22 14z' fill='%23b3e5fc' opacity='.35'/%3E%3Crect x='30' y='54' width='20' height='20' rx='2' fill='%238b5e3c'/%3E%3Crect x='32' y='56' width='16' height='14' rx='1' fill='%23ffd54f' opacity='.3'/%3E%3Crect x='16' y='46' width='11' height='10' rx='1.5' fill='%23bbb'/%3E%3Crect x='17' y='47' width='9' height='8' rx='1' fill='%23e3f2fd'/%3E%3Crect x='53' y='46' width='11' height='10' rx='1.5' fill='%23bbb'/%3E%3Crect x='54' y='47' width='9' height='8' rx='1' fill='%23e3f2fd'/%3E%3Crect x='17' y='63' width='5' height='8' rx='1.5' fill='%23e0e0e0' stroke='%23bbb' stroke-width='.4'/%3E%3Crect x='17' y='60' width='5' height='3' rx='1' fill='%23ccc'/%3E%3Crect x='58' y='63' width='5' height='8' rx='1.5' fill='%23e0e0e0' stroke='%23bbb' stroke-width='.4'/%3E%3Crect x='58' y='60' width='5' height='3' rx='1' fill='%23ccc'/%3E%3Ccircle cx='40' cy='30' r='4' fill='%23fff' opacity='.5' stroke='%2381d4fa' stroke-width='.5'/%3E%3Cpath d='M38 32v-4M42 32v-4M38 28h4' stroke='%2381d4fa' stroke-width='.6' fill='none'/%3E%3C/svg%3E",
  bbq: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80'%3E%3Cellipse cx='40' cy='76' rx='32' ry='4' fill='%23000' opacity='.1'/%3E%3Crect x='10' y='46' width='60' height='28' rx='3' fill='%23795548'/%3E%3Crect x='10' y='46' width='60' height='28' rx='3' stroke='%234e342e' stroke-width='.6' fill='none'/%3E%3Crect x='11' y='47' width='28' height='26' fill='%238d6e63' opacity='.2'/%3E%3Crect x='6' y='38' width='68' height='10' rx='2' fill='%23e53935'/%3E%3Crect x='6' y='38' width='68' height='4' fill='%23ef5350' rx='2'/%3E%3Cpath d='M6 38h68' stroke='%23fff' stroke-width='.5' opacity='.15'/%3E%3Crect x='18' y='50' width='44' height='18' rx='2' fill='%23424242'/%3E%3Cpath d='M22 54h36M22 58h36M22 62h36' stroke='%23666' stroke-width='1.5'/%3E%3Crect x='24' y='14' width='4' height='24' rx='1.5' fill='%23999'/%3E%3Crect x='36' y='12' width='4' height='26' rx='1.5' fill='%23999'/%3E%3Crect x='52' y='14' width='4' height='24' rx='1.5' fill='%23999'/%3E%3Cellipse cx='26' cy='11' rx='4' ry='5' fill='%23bbb' opacity='.3'/%3E%3Cellipse cx='38' cy='9' rx='5' ry='6' fill='%23ccc' opacity='.25'/%3E%3Cellipse cx='54' cy='11' rx='4' ry='5' fill='%23bbb' opacity='.2'/%3E%3Ccircle cx='30' cy='56' r='2' fill='%23ff6d00' opacity='.6'/%3E%3Ccircle cx='40' cy='58' r='2.5' fill='%23ff9800' opacity='.5'/%3E%3Ccircle cx='50' cy='56' r='2' fill='%23ff6d00' opacity='.4'/%3E%3C/svg%3E",
  pastry_shop: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80'%3E%3Cellipse cx='40' cy='76' rx='32' ry='4' fill='%23000' opacity='.1'/%3E%3Crect x='10' y='42' width='60' height='32' rx='3' fill='%23fff0f3'/%3E%3Crect x='10' y='42' width='60' height='32' rx='3' stroke='%23f8bbd0' stroke-width='.6' fill='none'/%3E%3Crect x='11' y='43' width='28' height='30' fill='%23fff5f7' opacity='.3'/%3E%3Cpath d='M5 42L40 18l35 24z' fill='%23f48fb1'/%3E%3Cpath d='M12 42L40 22l28 20z' fill='%23f8bbd0'/%3E%3Cpath d='M16 42L40 26l24 16z' fill='%23fce4ec' opacity='.35'/%3E%3Crect x='28' y='52' width='24' height='22' rx='2' fill='%238b5e3c'/%3E%3Crect x='30' y='54' width='20' height='16' rx='1' fill='%23ffd54f' opacity='.3'/%3E%3Crect x='14' y='48' width='11' height='9' rx='1.5' fill='%238b5e3c'/%3E%3Crect x='15' y='49' width='9' height='7' rx='1' fill='%23fce4ec' opacity='.35'/%3E%3Crect x='55' y='48' width='11' height='9' rx='1.5' fill='%238b5e3c'/%3E%3Crect x='56' y='49' width='9' height='7' rx='1' fill='%23fce4ec' opacity='.35'/%3E%3Ccircle cx='35' cy='63' r='5' fill='%23ffc107' stroke='%23e6a800' stroke-width='.5'/%3E%3Ccircle cx='35' cy='62' r='3.5' fill='%23ffe082'/%3E%3Crect x='33.5' y='60' width='3' height='5' rx='.5' fill='%23fff' opacity='.2'/%3E%3Ccircle cx='35' cy='59' r='1.8' fill='%23e53935'/%3E%3Ccircle cx='46' cy='65' r='4' fill='%23fce4ec' stroke='%23f48fb1' stroke-width='.5'/%3E%3Ccircle cx='46' cy='64' r='2.5' fill='%23fff'/%3E%3Ccircle cx='46' cy='62.5' r='1.2' fill='%23e91e63'/%3E%3Crect x='14' y='68' width='5' height='4' rx='1' fill='%23f48fb1' opacity='.4'/%3E%3Ccircle cx='16.5' cy='68' r='1.5' fill='%23e91e63' opacity='.5'/%3E%3Crect x='61' y='68' width='5' height='4' rx='1' fill='%23f48fb1' opacity='.4'/%3E%3Ccircle cx='63.5' cy='68' r='1.5' fill='%23e91e63' opacity='.5'/%3E%3Crect x='36' y='14' width='8' height='10' rx='1.5' fill='%23999'/%3E%3Cellipse cx='40' cy='12' rx='3' ry='4' fill='%23ccc' opacity='.35'/%3E%3C/svg%3E",
  jam_maker: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80'%3E%3Cellipse cx='40' cy='76' rx='32' ry='4' fill='%23000' opacity='.1'/%3E%3Crect x='10' y='42' width='60' height='32' rx='3' fill='%23f3e5f5'/%3E%3Crect x='10' y='42' width='60' height='32' rx='3' stroke='%23ce93d8' stroke-width='.5' fill='none'/%3E%3Crect x='11' y='43' width='28' height='30' fill='%23f8eafa' opacity='.3'/%3E%3Cpath d='M5 42L40 18l35 24z' fill='%239c27b0'/%3E%3Cpath d='M12 42L40 22l28 20z' fill='%23ba68c8'/%3E%3Cpath d='M16 42L40 26l24 16z' fill='%23ce93d8' opacity='.3'/%3E%3Crect x='30' y='54' width='18' height='20' rx='2' fill='%238b5e3c'/%3E%3Crect x='32' y='56' width='14' height='14' rx='1' fill='%23ffd54f' opacity='.25'/%3E%3Cpath d='M17 55h8v14a2 2 0 01-2 2h-4a2 2 0 01-2-2z' fill='%23e53935' stroke='%23c62828' stroke-width='.4'/%3E%3Crect x='18' y='52' width='6' height='3.5' rx='1' fill='%23e0e0e0'/%3E%3Ccircle cx='21' cy='62' r='1.5' fill='%23ef5350' opacity='.3'/%3E%3Ccircle cx='21' cy='58' r='1' fill='%23e53935' opacity='.4'/%3E%3Cpath d='M55 55h8v14a2 2 0 01-2 2h-4a2 2 0 01-2-2z' fill='%237b1fa2' stroke='%234a148c' stroke-width='.4'/%3E%3Crect x='56' y='52' width='6' height='3.5' rx='1' fill='%23e0e0e0'/%3E%3Ccircle cx='59' cy='62' r='1.5' fill='%23ab47bc' opacity='.3'/%3E%3Ccircle cx='59' cy='58' r='1' fill='%239c27b0' opacity='.4'/%3E%3Crect x='14' y='48' width='10' height='3' rx='1' fill='%239c27b0' opacity='.3'/%3E%3Ctext x='19' y='50.5' text-anchor='middle' font-size='2.5' fill='%23fff' opacity='.7'%3EJAM%3C/text%3E%3Ccircle cx='13' cy='70' r='2.5' fill='%23e53935' opacity='.35'/%3E%3Ccircle cx='16' cy='72' r='2' fill='%239c27b0' opacity='.3'/%3E%3Ccircle cx='64' cy='71' r='2.5' fill='%239c27b0' opacity='.3'/%3E%3Ccircle cx='67' cy='69' r='2' fill='%23e53935' opacity='.25'/%3E%3C/svg%3E",
  pizzeria: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80'%3E%3Cellipse cx='40' cy='76' rx='32' ry='4' fill='%23000' opacity='.1'/%3E%3Crect x='10' y='42' width='60' height='32' rx='3' fill='%23fff3e0'/%3E%3Crect x='10' y='42' width='60' height='32' rx='3' stroke='%23ffe0b2' stroke-width='.5' fill='none'/%3E%3Crect x='11' y='43' width='28' height='30' fill='%23fff8e1' opacity='.3'/%3E%3Cpath d='M5 42L40 18l35 24z' fill='%23d32f2f'/%3E%3Cpath d='M12 42L40 22l28 20z' fill='%23ef5350'/%3E%3Cpath d='M16 42L40 26l24 16z' fill='%23ef9a9a' opacity='.3'/%3E%3Cpath d='M6 38h68' stroke='none'/%3E%3Crect x='6' y='36' width='68' height='6' rx='1.5' fill='%23d32f2f' opacity='.6'/%3E%3Crect x='6' y='36' width='16' height='6' rx='1.5' fill='%23fff' opacity='.1'/%3E%3Crect x='38' y='36' width='16' height='6' rx='1.5' fill='%23fff' opacity='.1'/%3E%3Crect x='28' y='52' width='24' height='22' rx='2' fill='%238b5e3c'/%3E%3Crect x='30' y='54' width='20' height='16' rx='1' fill='%23ffd54f' opacity='.3'/%3E%3Crect x='14' y='48' width='11' height='9' rx='1.5' fill='%238b5e3c'/%3E%3Crect x='15' y='49' width='9' height='7' rx='1' fill='%23ffd54f' opacity='.25'/%3E%3Crect x='55' y='48' width='11' height='9' rx='1.5' fill='%238b5e3c'/%3E%3Crect x='56' y='49' width='9' height='7' rx='1' fill='%23ffd54f' opacity='.25'/%3E%3Ccircle cx='40' cy='63' r='7.5' fill='%23ffc107' stroke='%23d49a00' stroke-width='.6'/%3E%3Ccircle cx='40' cy='63' r='6' fill='%23ffecb3'/%3E%3Ccircle cx='36' cy='61' r='2.2' fill='%23e53935'/%3E%3Ccircle cx='43' cy='64' r='2' fill='%234caf50'/%3E%3Ccircle cx='39' cy='67' r='1.8' fill='%23e53935'/%3E%3Ccircle cx='44' cy='59' r='1.5' fill='%23ff9800'/%3E%3Cpath d='M37 62Q40 60 43 63' stroke='%23ffe082' stroke-width='.6' fill='none' opacity='.5'/%3E%3Crect x='60' y='20' width='6' height='22' rx='1.5' fill='%23999'/%3E%3Cellipse cx='63' cy='17' rx='4' ry='5' fill='%23bbb' opacity='.3'/%3E%3Cellipse cx='63' cy='14' rx='3' ry='4' fill='%23ccc' opacity='.2'/%3E%3C/svg%3E",
  juice_press: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80'%3E%3Cellipse cx='40' cy='76' rx='32' ry='4' fill='%23000' opacity='.1'/%3E%3Crect x='10' y='42' width='60' height='32' rx='3' fill='%23e8f5e9'/%3E%3Crect x='10' y='42' width='60' height='32' rx='3' stroke='%23a5d6a7' stroke-width='.5' fill='none'/%3E%3Crect x='11' y='43' width='28' height='30' fill='%23f1f8e9' opacity='.3'/%3E%3Cpath d='M5 42L40 18l35 24z' fill='%23ff9800'/%3E%3Cpath d='M12 42L40 22l28 20z' fill='%23ffb74d'/%3E%3Cpath d='M16 42L40 26l24 16z' fill='%23ffd54f' opacity='.3'/%3E%3Crect x='28' y='54' width='24' height='20' rx='2' fill='%238b5e3c'/%3E%3Crect x='30' y='56' width='20' height='14' rx='1' fill='%23ffd54f' opacity='.25'/%3E%3Crect x='14' y='48' width='11' height='9' rx='1.5' fill='%232e7d32'/%3E%3Crect x='15' y='49' width='9' height='7' rx='1' fill='%234caf50' opacity='.3'/%3E%3Crect x='55' y='48' width='11' height='9' rx='1.5' fill='%232e7d32'/%3E%3Crect x='56' y='49' width='9' height='7' rx='1' fill='%234caf50' opacity='.3'/%3E%3Ccircle cx='34' cy='63' r='5.5' fill='%23ff9800' stroke='%23e68900' stroke-width='.5'/%3E%3Ccircle cx='34' cy='62' r='4' fill='%23ffc107'/%3E%3Ccircle cx='33' cy='60.5' r='1.5' fill='%23fff' opacity='.35'/%3E%3Ccircle cx='47' cy='63' r='5' fill='%23fdd835' stroke='%23f9a825' stroke-width='.5'/%3E%3Ccircle cx='47' cy='62' r='3.5' fill='%23fff9c4'/%3E%3Ccircle cx='46' cy='60.5' r='1.2' fill='%23fff' opacity='.3'/%3E%3Ccircle cx='40' cy='25' r='7' fill='%23ff9800' stroke='%23e68900' stroke-width='.6'/%3E%3Ccircle cx='40' cy='25' r='5' fill='%23ffc107'/%3E%3Ccircle cx='38.5' cy='23.5' r='2' fill='%23fff' opacity='.3'/%3E%3Crect x='15' y='65' width='6' height='6' rx='1.5' fill='%23ff9800' opacity='.35'/%3E%3Crect x='59' y='65' width='6' height='6' rx='1.5' fill='%23fdd835' opacity='.35'/%3E%3C/svg%3E",
  pie_oven: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80'%3E%3Cellipse cx='40' cy='76' rx='32' ry='4' fill='%23000' opacity='.1'/%3E%3Crect x='10' y='42' width='60' height='32' rx='3' fill='%23efebe9'/%3E%3Crect x='10' y='42' width='60' height='32' rx='3' stroke='%23d7ccc8' stroke-width='.5' fill='none'/%3E%3Crect x='11' y='43' width='28' height='30' fill='%23f5f0ea' opacity='.3'/%3E%3Cpath d='M5 42L40 18l35 24z' fill='%23795548'/%3E%3Cpath d='M12 42L40 22l28 20z' fill='%238d6e63'/%3E%3Cpath d='M16 42L40 26l24 16z' fill='%23a1887f' opacity='.3'/%3E%3Crect x='20' y='52' width='40' height='18' rx='4' fill='%23424242'/%3E%3Crect x='22' y='54' width='36' height='14' rx='3' fill='%23333'/%3E%3Crect x='24' y='56' width='32' height='10' rx='2' fill='%23e65100' opacity='.65'/%3E%3Crect x='26' y='58' width='28' height='6' rx='1.5' fill='%23ff6d00' opacity='.35'/%3E%3Ccircle cx='32' cy='61' r='2.5' fill='%23ff9800' opacity='.5'/%3E%3Ccircle cx='40' cy='59' r='3' fill='%23ffab00' opacity='.45'/%3E%3Ccircle cx='48' cy='61' r='2.5' fill='%23ff6d00' opacity='.4'/%3E%3Crect x='14' y='48' width='10' height='8' rx='1.5' fill='%238b5e3c'/%3E%3Crect x='15' y='49' width='8' height='6' rx='1' fill='%23ffd54f' opacity='.25'/%3E%3Ccircle cx='19' cy='51' r='3' fill='%23e8b060' stroke='%23c99040' stroke-width='.4'/%3E%3Ccircle cx='19' cy='50.5' r='2' fill='%23daa06d'/%3E%3Crect x='56' y='48' width='10' height='8' rx='1.5' fill='%238b5e3c'/%3E%3Crect x='57' y='49' width='8' height='6' rx='1' fill='%23ffd54f' opacity='.25'/%3E%3Crect x='32' y='14' width='5' height='14' rx='1.5' fill='%23999'/%3E%3Crect x='44' y='12' width='5' height='16' rx='1.5' fill='%23999'/%3E%3Cellipse cx='34.5' cy='11' rx='4' ry='5' fill='%23bbb' opacity='.3'/%3E%3Cellipse cx='46.5' cy='9' rx='4' ry='5' fill='%23ccc' opacity='.25'/%3E%3Cellipse cx='34.5' cy='8' rx='3' ry='4' fill='%23ccc' opacity='.2'/%3E%3C/svg%3E",
};
...
function showSessionSummary(d){
  ...
  // Rating based on reviews count
  const rating = d.reviews >= 50 ? 3 : d.reviews >= 20 ? 2 : d.reviews >= 5 ? 1 : 0;
  const starSrc = S('hayday_star');
  const starHtml = starSrc ? `<img src="${starSrc}" width="22" height="22" style="vertical-align:middle;filter:drop-shadow(0 1px 2px rgba(0,0,0,.2))">` : '<span style="color:#ffd700;font-size:20px">&#9733;</span>';
  const starDimHtml = starSrc ? `<img src="${starSrc}" width="22" height="22" style="vertical-align:middle;filter:grayscale(1) opacity(.25)">` : '<span style="color:#ccc;font-size:20px">&#9733;</span>';
  const starsRow = `<div style="margin:6px 0 10px;display:flex;gap:4px;justify-content:center">${rating>=1?starHtml:starDimHtml}${rating>=2?starHtml:starDimHtml}${rating>=3?starHtml:starDimHtml}</div>`;
...
function showCoinBurst(x,y,n){
  ...
  // Fly one coin to the HUD counter for satisfying collection feel
  const hudCoins = document.getElementById('hud-coins');
  if (hudCoins && n > 0) {
    setTimeout(() => {
      const coinEl = document.createElement('div');
      coinEl.className = 'coin-fly-to-hud';
      if(coinSrc) coinEl.innerHTML=`<img src="${coinSrc}" width="18" height="18">`;
      else coinEl.innerHTML='<span class="css-coin" style="width:14px;height:14px"></span>';
      coinEl.style.left = (x||window.innerWidth/2) + 'px';
      coinEl.style.top = (y||window.innerHeight/2) + 'px';
      const hudRect = hudCoins.getBoundingClientRect();
      coinEl.style.setProperty('--target-x', (hudRect.left + hudRect.width/2 - (x||window.innerWidth/2)) + 'px');
      coinEl.style.setProperty('--target-y', (hudRect.top + hudRect.height/2 - (y||window.innerHeight/2)) + 'px');
      layer.appendChild(coinEl);
      setTimeout(() => { if(coinEl.parentNode) coinEl.parentNode.removeChild(coinEl); hudBump('hud-coins'); }, 650);
    }, 200);
  }
}
function showReward(d){
  ...
  if (coins > 0 || xp > 0) {
    ...
    // Normal reviews: subtle floating coin near HUD — every review should feel rewarding
    if (!isBig && !isSpecial && coins > 0) {
      const hudEl = document.getElementById('hud-coins');
      if (hudEl) {
        const r = hudEl.getBoundingClientRect();
        showFloatingReward(`+${coins}`, r.left + r.width/2, r.bottom + 12);
      }
    }
  }
