...
// --- Sprite Helpers ---
function S(key) {
  // Always prefer real PNG sprites (pixel art crops, hayday buildings, UI icons)
  if (typeof SPRITES !== 'undefined' && SPRITES[key]) return SPRITES[key];
  // Fallback to generated SVG only if no real sprite exists
...
function itemIcon(id, w) {
  w = w || 24;
  // Direct UI sprite match (coin, gem)
  const uiSrc = S(`ui_${id}`);
  if (uiSrc) return `<img src="${uiSrc}" width="${w}" height="${w}" style="object-fit:contain;vertical-align:middle">`;
...
// --- Inline SVG Building Icons (Hay Day style with signage) ---
const BUILDING_SVGS = {
  bakery: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80'%3E%3Cellipse cx='40' cy='76' rx='32' ry='4' fill='%23000' opacity='.12'/%3E%3Crect x='10' y='50' width='60' height='25' rx='3' fill='%23c9884a' stroke='%23a06a30' stroke-width='1'/%3E%3Crect x='11' y='51' width='58' height='4' rx='1' fill='%23daa06d' opacity='.35'/%3E%3Cpath d='M5 50L40 20l35 30z' fill='%23d4534a'/%3E%3Cpath d='M8 50L40 23l32 27z' fill='%23e8665e'/%3E%3Cpath d='M40 23l32 27H8z' fill='url(%23bakeryRoof)'/%3E%3Cdefs%3E%3ClinearGradient id='bakeryRoof' x1='0' y1='0' x2='0' y2='1'%3E%3Cstop offset='0' stop-color='%23ef8a84' stop-opacity='.4'/%3E%3Cstop offset='1' stop-color='%23d4534a' stop-opacity='0'/%3E%3C/linearGradient%3E%3C/defs%3E%3Crect x='29' y='55' width='22' height='20' rx='2' fill='%236d4c41'/%3E%3Crect x='31' y='57' width='18' height='14' rx='1' fill='%23ffd54f' opacity='.4'/%3E%3Cpath d='M31 64h18' stroke='%236d4c41' stroke-width='.7'/%3E%3Crect x='15' y='39' width='12' height='10' rx='1.5' fill='%236d4c41'/%3E%3Crect x='16.5' y='40' width='9' height='8' rx='1' fill='%23ffd54f' opacity='.35'/%3E%3Crect x='53' y='39' width='12' height='10' rx='1.5' fill='%236d4c41'/%3E%3Crect x='54.5' y='40' width='9' height='8' rx='1' fill='%23ffd54f' opacity='.35'/%3E%3Crect x='36' y='16' width='8' height='10' rx='2' fill='%23999'/%3E%3Cellipse cx='40' cy='13' rx='4' ry='5' fill='%23ddd' opacity='.4'/%3E%3Cellipse cx='40' cy='11' rx='3' ry='4' fill='%23eee' opacity='.3'/%3E%3Crect x='22' y='46' width='36' height='7' rx='3' fill='%238b5e3c' stroke='%236d4c41' stroke-width='.5'/%3E%3Ctext x='40' y='51.5' text-anchor='middle' font-size='5' font-weight='bold' fill='%23ffd54f' font-family='sans-serif'%3EBOULANGERIE%3C/text%3E%3Ccircle cx='40' cy='65' r='5' fill='%23e8c07a' stroke='%23c9884a' stroke-width='.5'/%3E%3Ccircle cx='40' cy='64' r='3.5' fill='%23daa06d'/%3E%3Ccircle cx='40' cy='62.5' r='.8' fill='%23c9884a' opacity='.5'/%3E%3Ccircle cx='38' cy='63.5' r='.6' fill='%23c9884a' opacity='.4'/%3E%3Ccircle cx='42' cy='64' r='.7' fill='%23c9884a' opacity='.4'/%3E%3C/svg%3E",
  sugar_mill: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80'%3E%3Cellipse cx='40' cy='76' rx='32' ry='4' fill='%23000' opacity='.12'/%3E%3Crect x='15' y='35' width='50' height='40' rx='3' fill='%23e0d5c0' stroke='%23c9b89a' stroke-width='.6'/%3E%3Crect x='16' y='36' width='48' height='4' rx='1' fill='%23efe6d5' opacity='.4'/%3E%3Cpath d='M10 35L40 15l30 20z' fill='%23c9884a'/%3E%3Cpath d='M13 35L40 18l27 17z' fill='%23daa06d'/%3E%3Crect x='30' y='55' width='20' height='20' rx='2' fill='%238b5e3c'/%3E%3Crect x='32' y='57' width='16' height='14' rx='1' fill='%23ffd54f' opacity='.3'/%3E%3Ccircle cx='57' cy='28' r='11' fill='%23c9884a' stroke='%23a06a30' stroke-width='1'/%3E%3Cpath d='M57 17v22M46 28h22' stroke='%23a06a30' stroke-width='2.5'/%3E%3Cpath d='M49.5 20.5l15 15M49.5 35.5l15-15' stroke='%23a06a30' stroke-width='1.5'/%3E%3Ccircle cx='57' cy='28' r='3.5' fill='%23daa06d'/%3E%3Ccircle cx='57' cy='28' r='1.5' fill='%23c9884a'/%3E%3Crect x='22' y='42' width='36' height='7' rx='3' fill='%238b5e3c' stroke='%236d4c41' stroke-width='.5'/%3E%3Ctext x='40' y='47.5' text-anchor='middle' font-size='5' font-weight='bold' fill='%23ffd54f' font-family='sans-serif'%3ESUCRERIE%3C/text%3E%3C/svg%3E",
  dairy: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80'%3E%3Cellipse cx='40' cy='76' rx='30' ry='4' fill='%23000' opacity='.1'/%3E%3Crect x='12' y='38' width='56' height='37' rx='3' fill='%23f0f0f0' stroke='%23ddd' stroke-width='.6'/%3E%3Crect x='13' y='39' width='54' height='4' fill='%23f8f8f8' opacity='.4'/%3E%3Cpath d='M8 38L40 16l32 22z' fill='%234fc3f7' stroke='%230288d1' stroke-width='.5'/%3E%3Cpath d='M11 38L40 19l29 19z' fill='%2381d4fa'/%3E%3Crect x='30' y='55' width='20' height='20' rx='2' fill='%238b5e3c' stroke='%236d4c41' stroke-width='.5'/%3E%3Crect x='32' y='57' width='16' height='14' rx='1' fill='%23ffd54f' opacity='.3'/%3E%3Crect x='16' y='46' width='11' height='10' rx='1.5' fill='%23bbb' stroke='%23999' stroke-width='.3'/%3E%3Crect x='17' y='47' width='9' height='8' rx='1' fill='%23e3f2fd'/%3E%3Crect x='53' y='46' width='11' height='10' rx='1.5' fill='%23bbb' stroke='%23999' stroke-width='.3'/%3E%3Crect x='54' y='47' width='9' height='8' rx='1' fill='%23e3f2fd'/%3E%3Crect x='20' y='44' width='40' height='7' rx='3' fill='%230288d1' stroke='%230277bd' stroke-width='.5'/%3E%3Ctext x='40' y='49.5' text-anchor='middle' font-size='5' font-weight='bold' fill='%23fff' font-family='sans-serif'%3ELAITERIE%3C/text%3E%3Ccircle cx='40' cy='65' r='4' fill='%23fff' opacity='.5'/%3E%3Ccircle cx='40' cy='65' r='2.5' fill='%2381d4fa' opacity='.6'/%3E%3C/svg%3E",
  bbq: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80'%3E%3Cellipse cx='40' cy='76' rx='30' ry='4' fill='%23000' opacity='.12'/%3E%3Crect x='12' y='40' width='56' height='35' rx='3' fill='%23795548' stroke='%234e342e' stroke-width='.6'/%3E%3Crect x='13' y='41' width='54' height='4' fill='%238d6e63' opacity='.3'/%3E%3Cpath d='M8 40L40 18l32 22z' fill='%23e53935' stroke='%23c62828' stroke-width='.5'/%3E%3Cpath d='M11 40L40 21l29 19z' fill='%23ef5350'/%3E%3Crect x='30' y='56' width='20' height='19' rx='2' fill='%235d4037'/%3E%3Crect x='32' y='58' width='16' height='13' rx='1' fill='%23ffd54f' opacity='.25'/%3E%3Crect x='34' y='14' width='4' height='10' rx='1.5' fill='%23999'/%3E%3Crect x='43' y='12' width='4' height='12' rx='1.5' fill='%23999'/%3E%3Cellipse cx='36' cy='12' rx='4' ry='5' fill='%23bbb' opacity='.25'/%3E%3Cellipse cx='45' cy='10' rx='4.5' ry='5.5' fill='%23bbb' opacity='.2'/%3E%3Cellipse cx='36' cy='10' rx='3' ry='4' fill='%23ddd' opacity='.15'/%3E%3Crect x='20' y='46' width='40' height='7' rx='3' fill='%238b5e3c' stroke='%236d4c41' stroke-width='.5'/%3E%3Ctext x='40' y='51.5' text-anchor='middle' font-size='6.5' font-weight='bold' fill='%23ffd54f' font-family='sans-serif'%3EBBQ%3C/text%3E%3C/svg%3E",
  pastry_shop: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80'%3E%3Cellipse cx='40' cy='76' rx='32' ry='4' fill='%23000' opacity='.1'/%3E%3Crect x='10' y='42' width='60' height='33' rx='3' fill='%23fff8e1' stroke='%23e8c87a' stroke-width='.6'/%3E%3Crect x='11' y='43' width='58' height='4' fill='%23fffde7' opacity='.4'/%3E%3Cpath d='M5 42L40 18l35 24z' fill='%23ff9800'/%3E%3Cpath d='M9 42L40 21l31 21z' fill='%23ffb74d'/%3E%3Crect x='28' y='52' width='24' height='23' rx='2' fill='%238b5e3c'/%3E%3Crect x='30' y='54' width='20' height='16' rx='1' fill='%23ffd54f' opacity='.3'/%3E%3Crect x='14' y='48' width='11' height='9' rx='1.5' fill='%238b5e3c'/%3E%3Crect x='15.5' y='49' width='8' height='7' rx='1' fill='%23ffd54f' opacity='.25'/%3E%3Crect x='55' y='48' width='11' height='9' rx='1.5' fill='%238b5e3c'/%3E%3Crect x='56.5' y='49' width='8' height='7' rx='1' fill='%23ffd54f' opacity='.25'/%3E%3Crect x='18' y='48' width='44' height='7' rx='3' fill='%23e68a00' stroke='%23c67400' stroke-width='.5'/%3E%3Ctext x='40' y='53.5' text-anchor='middle' font-size='4.5' font-weight='bold' fill='%23fff' font-family='sans-serif'%3EPATISSERIE%3C/text%3E%3Ccircle cx='35' cy='64' r='4.5' fill='%23ffc107' stroke='%23e6a800' stroke-width='.4'/%3E%3Ccircle cx='35' cy='63' r='3' fill='%23ffe082'/%3E%3Ccircle cx='35' cy='61.5' r='1.5' fill='%23e74c3c'/%3E%3Ccircle cx='46' cy='66' r='3.5' fill='%23efebe9' stroke='%23d7ccc8' stroke-width='.4'/%3E%3Ccircle cx='46' cy='65' r='2.5' fill='%23fce4ec'/%3E%3Crect x='36' y='14' width='8' height='10' rx='1.5' fill='%23999'/%3E%3Cellipse cx='40' cy='12' rx='3' ry='4' fill='%23ccc' opacity='.4'/%3E%3C/svg%3E",
  jam_maker: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80'%3E%3Cellipse cx='40' cy='76' rx='32' ry='4' fill='%23000' opacity='.1'/%3E%3Crect x='10' y='42' width='60' height='33' rx='3' fill='%23efebe9' stroke='%23d7ccc8' stroke-width='.6'/%3E%3Crect x='11' y='43' width='58' height='4' fill='%23f5f0ea' opacity='.4'/%3E%3Cpath d='M5 42L40 18l35 24z' fill='%239c27b0'/%3E%3Cpath d='M9 42L40 21l31 21z' fill='%23ba68c8'/%3E%3Crect x='28' y='52' width='24' height='23' rx='2' fill='%238b5e3c'/%3E%3Crect x='30' y='54' width='20' height='16' rx='1' fill='%23ffd54f' opacity='.25'/%3E%3Cpath d='M18 56h8v14a3 3 0 01-3 3h-2a3 3 0 01-3-3z' fill='%23e53935' stroke='%23c62828' stroke-width='.4'/%3E%3Crect x='19' y='52' width='6' height='4' rx='1' fill='%23e0e0e0'/%3E%3Cpath d='M54 56h8v14a3 3 0 01-3 3h-2a3 3 0 01-3-3z' fill='%237b1fa2' stroke='%234a148c' stroke-width='.4'/%3E%3Crect x='55' y='52' width='6' height='4' rx='1' fill='%23e0e0e0'/%3E%3Crect x='18' y='48' width='44' height='7' rx='3' fill='%237b1fa2' stroke='%234a148c' stroke-width='.5'/%3E%3Ctext x='40' y='53.5' text-anchor='middle' font-size='4.5' font-weight='bold' fill='%23fff' font-family='sans-serif'%3ECONFITURERIE%3C/text%3E%3Ccircle cx='40' cy='64' r='5' fill='%23ffc107' stroke='%23e6a800' stroke-width='.4'/%3E%3Ccircle cx='37' cy='62' r='1.5' fill='%23e53935'/%3E%3Ccircle cx='42' cy='63' r='1.5' fill='%239c27b0'/%3E%3Ccircle cx='40' cy='67' r='1.2' fill='%23e53935'/%3E%3C/svg%3E",
  pizzeria: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80'%3E%3Cellipse cx='40' cy='76' rx='32' ry='4' fill='%23000' opacity='.1'/%3E%3Crect x='10' y='42' width='60' height='33' rx='3' fill='%23fff3e0' stroke='%23ffe0b2' stroke-width='.6'/%3E%3Crect x='11' y='43' width='58' height='4' fill='%23fff8e1' opacity='.4'/%3E%3Cpath d='M5 42L40 18l35 24z' fill='%23d32f2f'/%3E%3Cpath d='M9 42L40 21l31 21z' fill='%23ef5350'/%3E%3Crect x='28' y='52' width='24' height='23' rx='2' fill='%238b5e3c'/%3E%3Crect x='30' y='54' width='20' height='16' rx='1' fill='%23ffd54f' opacity='.3'/%3E%3Crect x='14' y='48' width='11' height='9' rx='1.5' fill='%238b5e3c'/%3E%3Crect x='55' y='48' width='11' height='9' rx='1.5' fill='%238b5e3c'/%3E%3Crect x='18' y='48' width='44' height='7' rx='3' fill='%23c62828' stroke='%23b71c1c' stroke-width='.5'/%3E%3Ctext x='40' y='53.5' text-anchor='middle' font-size='5' font-weight='bold' fill='%23ffd54f' font-family='sans-serif'%3EPIZZERIA%3C/text%3E%3Ccircle cx='40' cy='64' r='7' fill='%23ffc107' stroke='%23e6a800' stroke-width='.6'/%3E%3Ccircle cx='40' cy='64' r='5.5' fill='%23ffecb3'/%3E%3Ccircle cx='36' cy='62' r='2' fill='%23e53935'/%3E%3Ccircle cx='43' cy='65' r='1.8' fill='%234caf50'/%3E%3Ccircle cx='39' cy='68' r='1.5' fill='%23e53935'/%3E%3Ccircle cx='44' cy='61' r='1.3' fill='%23ff9800'/%3E%3Crect x='36' y='14' width='8' height='10' rx='1.5' fill='%23999'/%3E%3Cellipse cx='40' cy='12' rx='3' ry='4' fill='%23ccc' opacity='.35'/%3E%3C/svg%3E",
  juice_press: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80'%3E%3Cellipse cx='40' cy='76' rx='32' ry='4' fill='%23000' opacity='.1'/%3E%3Crect x='10' y='42' width='60' height='33' rx='3' fill='%23e8f5e9' stroke='%23c8e6c9' stroke-width='.6'/%3E%3Crect x='11' y='43' width='58' height='4' fill='%23f1f8e9' opacity='.4'/%3E%3Cpath d='M5 42L40 18l35 24z' fill='%23ff9800'/%3E%3Cpath d='M9 42L40 21l31 21z' fill='%23ffb74d'/%3E%3Crect x='28' y='52' width='24' height='23' rx='2' fill='%238b5e3c'/%3E%3Crect x='30' y='54' width='20' height='16' rx='1' fill='%23ffd54f' opacity='.25'/%3E%3Crect x='14' y='48' width='11' height='9' rx='1.5' fill='%232e7d32'/%3E%3Crect x='55' y='48' width='11' height='9' rx='1.5' fill='%232e7d32'/%3E%3Crect x='18' y='48' width='44' height='7' rx='3' fill='%23e68a00' stroke='%23c67400' stroke-width='.5'/%3E%3Ctext x='40' y='53.5' text-anchor='middle' font-size='5' font-weight='bold' fill='%23fff' font-family='sans-serif'%3EPRESSOIR%3C/text%3E%3Ccircle cx='34' cy='64' r='5' fill='%23ff9800' stroke='%23e68900' stroke-width='.4'/%3E%3Ccircle cx='34' cy='63' r='3.5' fill='%23ffc107'/%3E%3Ccircle cx='33' cy='62' r='1' fill='%23fff' opacity='.3'/%3E%3Ccircle cx='47' cy='64' r='4.5' fill='%23fdd835' stroke='%23f9a825' stroke-width='.4'/%3E%3Ccircle cx='47' cy='63' r='3' fill='%23fff9c4'/%3E%3Ccircle cx='46' cy='62' r='1' fill='%23fff' opacity='.3'/%3E%3C/svg%3E",
  pie_oven: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80'%3E%3Cellipse cx='40' cy='76' rx='32' ry='4' fill='%23000' opacity='.1'/%3E%3Crect x='10' y='42' width='60' height='33' rx='3' fill='%23efebe9' stroke='%23d7ccc8' stroke-width='.6'/%3E%3Crect x='11' y='43' width='58' height='4' fill='%23f5f0ea' opacity='.4'/%3E%3Cpath d='M5 42L40 18l35 24z' fill='%23795548'/%3E%3Cpath d='M9 42L40 21l31 21z' fill='%238d6e63'/%3E%3Crect x='22' y='52' width='36' height='18' rx='4' fill='%23424242' stroke='%23333' stroke-width='.5'/%3E%3Crect x='24' y='54' width='32' height='14' rx='3' fill='%23e65100' opacity='.6'/%3E%3Crect x='26' y='56' width='28' height='10' rx='2' fill='%23ff6d00' opacity='.3'/%3E%3Ccircle cx='32' cy='61' r='3' fill='%23ff9800' opacity='.5'/%3E%3Ccircle cx='40' cy='59' r='2.5' fill='%23ffab00' opacity='.5'/%3E%3Ccircle cx='48' cy='61' r='2.5' fill='%23ff6d00' opacity='.4'/%3E%3Crect x='18' y='48' width='44' height='7' rx='3' fill='%234e342e' stroke='%233e2723' stroke-width='.5'/%3E%3Ctext x='40' y='53.5' text-anchor='middle' font-size='4.5' font-weight='bold' fill='%23ffd54f' font-family='sans-serif'%3EFOUR A TARTES%3C/text%3E%3Crect x='35' y='14' width='4' height='10' rx='1.5' fill='%23999'/%3E%3Crect x='42' y='12' width='4' height='12' rx='1.5' fill='%23999'/%3E%3Cellipse cx='37' cy='12' rx='3.5' ry='4' fill='%23bbb' opacity='.3'/%3E%3Cellipse cx='44' cy='10' rx='3' ry='3.5' fill='%23ccc' opacity='.25'/%3E%3C/svg%3E",
};
...
function renderFields() {
  ...
  fields.forEach(field => {
    ...
    if (field.state === 'empty') {
      ...
      el.innerHTML += `<div class="plot-crop">${cropImg(field.crop, stage, cropSize)}</div><div class="plot-progress"><div class="plot-progress-fill" style="width:${pct}%"></div></div><div class="plot-crop-name"><span>${cName} · ${pctRound}%</span></div>`;
  ...
  sortedOrders.forEach(order => {
    ...
    card.innerHTML = `
      <div class="order-header">
        ...
        <span class="order-reward"><span class="order-coin-reward">${itemIcon('coin',13)||'<span class="css-coin" style="width:12px;height:12px;display:inline-block;vertical-align:middle"></span>'} ${order.coin_reward}</span> <span class="order-xp-reward">+${order.xp_reward} XP</span>${order.type==='boat'?`<span class="order-gem-reward">${itemIcon('gem',12)||'<span class="css-gem" style="width:10px;height:12px;display:inline-block;vertical-align:middle"></span>'} Bonus</span>`:''}</span>
      </div>
...
function showPlantDialog(plotId){
  ...
  (farmData.unlocked_crops||[]).forEach(id => {
    ...
    const avgYield = Math.round(((def.harvest_min||2) + (def.harvest_max||4)) / 2);
    ...
    const el = document.createElement('div');
    el.className = 'crop-choice' + (canAfford ? '' : ' crop-choice-locked');
    el.onclick = () => {
    ...
    const stockTag = stock > 0 ? `<span class="crop-stock-tag">${stock}</span>` : '';
    const growTag = growing > 0 ? `<span class="crop-grow-tag">${growing}</span>` : '';
    el.innerHTML = `
      <div class="crop-choice-icon">${cropPortrait(id, 44) || itemIcon(id, 44)}</div>
      <strong class="crop-choice-name">${name}</strong>
      ${costHtml}
      <div class="crop-choice-stats">
        <span title="Révisions pour pousser">${totalReviews} rev</span>
        <span title="Prix de vente">${itemIcon('coin',10)} ${sellPrice}</span>
        <span class="crop-profit" title="Profit net">+${profit}</span>
      </div>
      ${stockTag}${growTag}
    `;
...
function showLevelUp(d){
  ...
  let rw='';if(d.gem_reward>0)rw=`${itemIcon('gem',18)} +${d.gem_reward} ${LANG.gemmes}`;
