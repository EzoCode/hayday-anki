...
ACHIEVEMENT_DEFS: List[Dict] = [
    ...
    },
    {
        ...
        "desc": "Réviser {target} cartes au total",
        "category": "reviews",
        "icon": "\U0001F4DA",
        "tiers": [
    ...
    # --- SERIES ---
    {
        "id": "on_fire",
        "name": "En feu",
        "desc": "Maintenir une série de {target} jours",
        "category": "streaks",
        "icon": "\U0001F525",
        "tiers": [
    ...
    # --- PRECISION ---
    {
        "id": "sharp_mind",
        "name": "Esprit vif",
        "desc": "Atteindre {target}% de précision en session (20+ cartes)",
        "category": "accuracy",
        "icon": "\U0001F3AF",
        "tiers": [
    ...
    },
    {
        ...
        "desc": "100% de précision sur {target}+ cartes en une session",
        "category": "accuracy",
        "icon": "\U0001F31F",
        "tiers": [
    ...
    },
    {
        ...
        "desc": "Maintenir {target}%+ de rétention globale",
        "category": "accuracy",
        "icon": "\U0001F4C8",
        "tiers": [
    ...
    # --- HORAIRES ---
    {
        "id": "early_bird",
        "name": "Lève-tôt",
        "desc": "Réviser avant 7h {target} fois",
        "category": "time",
        "icon": "\U0001F426",
        "tiers": [
    ...
    },
    {
        "id": "night_owl",
        "name": "Couche-tard",
        "desc": "Réviser après 23h {target} fois",
        "category": "time",
        "icon": "\U0001F989",
        "tiers": [
            {"tier": "bronze", "target": 1, "gems": 1},
    ...
    },
    {
        ...
        "desc": "Réviser pendant {target} weekends",
        "category": "time",
        "icon": "\U0001F3D6\uFE0F",
        "tiers": [
    ...
    {
        "id": "dedicated_hours",
        "name": "Heures de dévouement",
        "desc": "Passer {target} heures à étudier",
        "category": "time",
        "icon": "\u23F0",
        "tiers": [
    ...
    {
        "id": "crop_variety",
        "name": "Variété de cultures",
        "desc": "Cultiver {target} types différents",
        "category": "farming",
        "icon": "\U0001F33B",
        "tiers": [
            {"tier": "bronze", "target": 3, "gems": 1},
    ...
    # --- COLLECTIONS ---
    {
        "id": "decorator",
        "name": "Décorateur",
        "desc": "Placer {target} décorations sur la ferme",
    ...
    {
        "id": "deco_collector",
        "name": "Collectionneur de déco",
        "desc": "Posséder {target} types de décorations uniques",
        "category": "collections",
        "icon": "\U0001F3C6",
        "tiers": [
            {"tier": "bronze", "target": 5, "gems": 2},
    ...
    # --- ECONOMIE ---
    {
        ...
        "desc": "Gagner {target} pièces au total",
        "category": "economy",
        "icon": "\U0001FA99",
        "tiers": [
    ...
    },
    {
        ...
        "desc": "Dépenser {target} pièces au total",
        "category": "economy",
        "icon": "\U0001F4B0",
        "tiers": [
    ...
    # --- COMMANDES ---
    {
        "id": "trucker",
        "name": "Camionneur",
        "desc": "Compléter {target} commandes camion",
        "category": "orders",
        "icon": "\U0001F69A",
        "tiers": [
            {"tier": "bronze", "target": 5, "gems": 1},
    ...
    },
    {
        "id": "sailor",
        "name": "Marin",
        "desc": "Compléter {target} commandes bateau",
        "category": "orders",
        "icon": "\u26F5",
        "tiers": [
            {"tier": "bronze", "target": 5, "gems": 1},
    ...
    # --- PRODUCTION ---
    {
        "id": "chef",
        "name": "Chef cuisinier",
        "desc": "Produire {target} produits transformés",
        "category": "production",
    ...
    # --- MYSTERE & CHANCE ---
    {
        ...
        "desc": "Ouvrir {target} boîtes mystère",
        "category": "luck",
        "icon": "\U0001F381",
        "tiers": [
            {"tier": "bronze", "target": 5, "gems": 1},
    ...
    },
    {
        ...
        "name": "Collecteur de matériaux",
        "desc": "Collecter {target} matériaux",
        "category": "luck",
        "icon": "\U0001F529",
        "tiers": [
            {"tier": "bronze", "target": 10, "gems": 1},
    ...
    {
        "id": "barn_builder",
        "name": "Bâtisseur de grange",
        "desc": "Améliorer la grange {target} fois",
        "category": "upgrades",
        "icon": "\U0001F3DA\uFE0F",
        "tiers": [
            {"tier": "bronze", "target": 3, "gems": 1},
    ...
    },
    {
        "id": "silo_master",
        "name": "Maître du silo",
        "desc": "Améliorer le silo {target} fois",
        "category": "upgrades",
        "icon": "\U0001F3ED",
        "tiers": [
            {"tier": "bronze", "target": 3, "gems": 1},
    ...
    },
    {
        "id": "land_baron",
        "name": "Baron foncier",
        "desc": "Agrandir la ferme à {target} parcelles",
        "category": "upgrades",
        "icon": "\U0001F30D",
        "tiers": [
